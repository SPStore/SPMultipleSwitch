#
#  Be sure to run `pod spec lint SPMultipleSwitch.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "SPMultipleSwitch"
  spec.version      = "1.0"
  spec.summary      = "一个分段选择器"
  ...
  spec.source_files  = "SPMultipleSwitch"
